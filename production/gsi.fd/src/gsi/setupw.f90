...
!       BTH: Additional QC for HU3ASCAT (isubtype==6) winds: Any
!            wind with an assigned pressure less than 950.0 mb
!            is rejected. This is done to mimic the assigned
!            pressures of conventional ASCAT winds, which do not
!            appear to exist at p<950 mb.
        if (icsubtype(ikx)==6 .and. presw<950.0) then ! HU3ASCAT winds
           error = zero
        endif
     endif
